                        ...
                        <div className="tile">
                          <div className="tile is-parent is-vertical">
                            <article className="tile is-child">
                              ...
                              <p>
                                Nasza poradnia zajmuje się całym procesem
                                leczenia pacjenta, lekarz zaczynając od
                                profilaktyki, po diagnostykę, leczenie,
                                rehabilitację oraz kontrolę stanu zdrowia.
                                Wiedza internistyczna naszych specjalistów
                                obejmuje szczegółową znajomość fizjologii i
                                chorób układu: krążenia, pokarmowego,
                                oddechowego, moczowego, wydzielania
                                wewnętrznego, krwiotwórczego, odpornościowego i
                                narządu ruchu. Realizujemy kompleksową ocenę
                                stanu zdrowia. Oferujemy szybką diagnostykę
                                wszelkich schorzeń internistycznych oraz
                                natychmiastowe podjęcie leczenia chorób
                                wewnętrznych, zarówno tych najczęściej
                                spotykanych, jak i tych nietypowych.
                              </p>
                            </article>
                            <H2 isBlue>
                            ...
                            <p>
                              Najczęstsze choroby rozpoznawane i leczone przez
                              internistów to:
                            </p>
                            <div className="tile is-ancestor">
                                ...
                                <div className="tile is-child">
                                  <BoxNeutralColor>
                                    <article className="tile is-child">
                                      ...
                                      <li>
                                        ・ kamica, zapalenie pęcherza moczowego
                                      </li>
                                      <li>
                                ...
                                <div className="tile is-child">
                                  <BoxNeutralColor>
                                    <article className="tile is-child">
                                      ...
                                      <li>
                                        ・ zmiany zwyrodnieniowe kręgosłupa i
                                        stawów
                                      </li>
