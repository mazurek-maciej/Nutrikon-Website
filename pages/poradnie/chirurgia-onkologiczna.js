    ...
    return (
      <Layout>
        <SEO
          ...
          keywords={[
            'chirurgia onkologiczna, choroby nowotworowe, schorzenia onkologiczne, onkologia Opole',
          ]}
          lang="pl/PL"
        />
                        ...
                        <div className="tile">
                          <div className="tile is-parent is-vertical">
                            <article className="tile is-child">
                              ...
                              <p>
                                Poradnia Chirurgii Onkologicznej w Opolu zajmuje
                                się diagnostyką chorób nowotworowych i leczeniem
                                schorzeń onkologicznych. Obejmuje kwalifikację
                                do leczenia operacyjnego w warunkach szpitalnych
                                oraz pełną opiekę pooperacyjną.
                              </p>
                            </article>
                            <BoxNeutralColor>
                              <article className="tile is-child">
                                ...
                                <li>
                                  ・ Diagnostyka i leczenie stanów przedrakowych
                                  i rakowych skóry
                                </li>
                                <li>
                                  ・ Diagnostyka i usuwanie innych zmian
                                  skórnych oraz tłuszczaków, kaszaków,
                                  włókniaków i innych guzów położonych w tkance
                                  podskórnej
                                </li>
                                <li>
                                  ・ Diagnostyka i leczenie chorób gruczołu
                                  piersiowego
                                </li>
                                <li>
                                  ・ Badanie kliniczne piersi – interpretacja
                                  chirurgiczno – onkologiczna opisów badań
                                  obrazowych piersi (USG, mammografia)
                                </li>
                                <li>
                                  ・ Diagnostyka inwazyjna (biopsje)
                                  powiększonych węzłów chłonnych i innych guzów
                                </li>
                                <li>・ Biopsja tarczycy</li>
                                <li>・ Biopsja węzłów</li>
                                <li>
                                  ・ Kierowanie do planowego leczenia
                                  szpitalnego w oddziale chirurgicznym,
                                  onkologicznym i uzdrowiskowego oraz ośrodków
                                  klinicznych
                                </li>
                                <li>
                                ...
                                <li>
                                  ・ Inne porady z zakresu chirurgii
                                  onkologicznej.
                                </li>
                              </article>
                            </BoxNeutralColor>
