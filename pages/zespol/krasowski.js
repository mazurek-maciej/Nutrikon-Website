...
class Krasowski extends Component {
  render() {
    return (
      <Layout>
        <SEO
            ...
            <Container>
              ...
              <div className="columns">
                ...
                <LargeColumn className="column is-8">
                  <H2 blue>Życiorys</H2>
                  <p>
                    W 1993 roku ukończył Akademię Medyczną we Wrocławiu. W 1998
                    roku zdał egzaminy i uzyskał tytuł chirurga ogólnego, a w
                    2004 roku tytuł specjalisty z zakresu chirurgii ogólnej.
                  </p>
                  <p>
                    W 2001 roku obronił pracę doktorską "Niewydolność żył
                    kończyn dolnych u kobiet w ciąży i w połogu" i uzyskał tytuł
                  ...
                  <p>
                    ...
                    Publikuje wyniki w literaturze naukowej, uczestniczy w
                    pisaniu podręczników medycznych - w 2009 został wydany
                    Podręcznik Angiologii pod redakcją Prof. A. Sieronia, Z.
                    Rybaka i innych, którego jest współautorem.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    żylnych, leczeniem przewlekłych ran-owrzodzeń kończyn
                    dolnych. Wykonuje przetoki tętniczo-żylne dla potrzeb
                    dializoterapii.
                  </p>
                  <p>
                    ・ Kwalifikuje i wykonuje zabiegi onkologiczne dotyczące
                    schorzeń przewodu pokarmowego: żołądka, jelita, jelita
                    grubego.
                  </p>
                  <p>・ Wykonuje operacje usunięcia tarczycy.</p>
                  <p>
                    ・ Wykonuje zabiegi laparoskopowe: usunięcia pęcherzyka
                    żółciowego, wyrostka robaczkowego, śledziony , nadnerczy,
                    zmian guzowatych w jamie brzusznej itd.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    przełykowego, plastyczne w przypadkach przepuklin
                    pachwinowych i brzusznych z użyciem siatek. Zabiegi
                    naprawcze w przepuklinach wykonuje również w technice
                    małoinwazyjnej-laparoskopowej.
                  </p>
                  <p>
                    ・ Zajmuje się zabiegami proktologicznymi- hemoroidy,
                    szczeliny odbytu, przetoki okołoodbytnicze. Usuwa zmiany
                    skórne i w tkance podskórnej.
                  </p>
                  <p>
                    ・ Wykonuję zabiegi ostrodyżurowe w zakresie jamy brzusznej,
                    klatki piersiowej i naczyń krwionośnych. Zajmuję się
                    żywieniem poza i dojelitowym, wykonuję przetoki odżywcze w
                    technice małoinwazyjnej (PEG).
                  </p>
                  ...
                  <p>
                    Współpracuje z różnego rodzaju specjalistami dążąc do
                    właściwej diagnostyki i kompleksowego leczenia swoich
                    pacjentów.
                  </p>
                </LargeColumn>
              </div>
