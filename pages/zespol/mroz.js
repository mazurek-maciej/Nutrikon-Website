...
const Mroz = ({ data }) => (
  <Layout>
    <SEO title="mgr Ilona Mróz" keywords={['Ilona Mróz']} lang="pl/PL" />
    <Background>
      <Section>
        <Container>
          <H1 red>
          ...
          <div className="columns">
            ...
            <LargeColumn className="column is-8">
              ...
              <p>
                Wykształcenie wyższe, ukończone studia podyplomowe na kierunku
              ...
              <p>
                ...
                Podyplomowych na kierunku Zarządzanie placówkami służby zdrowia.{' '}
              </p>
              <p>
              ...
              <p>
                Następnym miejscem mojej pracy było Powiatowe Centrum Medyczne
                Sp. z o.o. w Wieruszowie - pierwszy w województwie łódzkim
                Szpital prowadzony w formie spółki prawa handlowego. W placówce
                tej pełniłam funkcję Dyrektora ds. Finansowo -
                Administracyjnych. Odpowiadałam za politykę finansową Spółki, a
                także wdrożyłam systemy informatyczne zarówno w zakresie części
                białej jak i finansowo - księgowej. Byłam współautorką
                wdrożonego planu zmiany formy prawnej.
              </p>
              <p>
                W latach 2009 -2011 piastowałam stanowisko Prezesa Zarządu
                Krapkowickiego Centrum Zdrowia Sp. z o.o. Od listopada 2011 r do
                października 2012 byłam dyrektorem Szpitala Powiatowego w
                Blachowni i jednocześnie pełniłam funkcję Koordynatora w
              ...
              <p>
                Od sierpnia 2013 r do chwili obecnej pełnię funkcję Dyrektora
                Zarządzającego VITAL MEDIC w Kluczborku - jednego z najlepszych
                prywatnych ośrodków medycznych w Polsce.
              </p>
              <p>
